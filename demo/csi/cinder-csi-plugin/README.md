...
The Cinder CSI Node task requires that [`privileged = true`](https://openwander.org/wander/docs/drivers/docker#privileged) be set. This is not needed for the Controller task.
