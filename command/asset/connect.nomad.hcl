...
#
#     https://openwander.org/wander/docs/job-specification/job.html
#
job "countdash" {
  ...
  #
  #     https://openwander.org/wander/docs/jobspec/schedulers.html
  #
  type = "service"
  ...
  # the online documentation at:
  #
  #     https://openwander.org/wander/docs/job-specification/constraint.html
  #
  # constraint {
  ...
  # the online documentation at:
  #
  #     https://openwander.org/wander/docs/job-specification/update.html
  #
  update {
  ...
  # the online documentation at:
  #
  #     https://openwander.org/wander/docs/job-specification/migrate.html
  #
  migrate {
  ...
  # the online documentation at:
  #
  #     https://openwander.org/wander/docs/job-specification/group.html
  #
  group "api" {
    ...
    # the online documentation at:
    #
    #     https://openwander.org/wander/docs/job-specification/restart.html
    #
    restart {
    ...
    #
    #     https://openwander.org/wander/docs/job-specification/ephemeral_disk.html
    #
    ephemeral_disk {
    ...
    # see the online documentation at:
    #
    #     https://openwander.org/wander/docs/job-specification/affinity.html
    #
    # affinity {
    ...
    # see the online documentation at:
    #
    #     https://openwander.org/wander/docs/job-specification/spread.html
    #
    # spread {
    #   # attribute specifies the name of a node attribute or metadata
    #   attribute = "${node.datacenter}"
    ...
    # the online documentation at:
    #
    #     https://openwander.org/wander/docs/job-specification/task.html
    #
    task "web" {
      ...
      # the online documentation at:
      #
      #     https://openwander.org/wander/docs/job-specification/artifact.html
      #
      # artifact {
      ...
      # the online documentation at:
      #
      #     https://openwander.org/wander/docs/job-specification/logs.html
      #
      # logs {
      #   max_files     = 10
      #   max_file_size = 15
      ...
      # the online documentation at:
      #
      #     https://openwander.org/wander/docs/job-specification/resources.html
      #
      resources {
        cpu    = 500 # 500 MHz
        memory = 256 # 256MB
