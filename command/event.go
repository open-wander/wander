...
func (e *EventCommand) Help() string {
	helpText := `
Usage: wander event <subcommand> [options] [args]

  This command groups subcommands for interacting with Wander event sinks.
  Wander's event sinks system can be used to subscribe to the event stream for
