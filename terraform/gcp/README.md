...
This tutorial will teach you how to deploy [Nomad](https://openwander.org/wander/) clusters to the Google Cloud Platform using [Packer](https://www.packer.io/) and [Terraform](https://www.terraform.io/).
...
Download the latest version of [Nomad](https://openwander.org/wander/) from HashiCorp's website by copying and pasting this snippet in the terminal:
