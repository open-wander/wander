...
[Scheduling in Nomad]: https://openwander.org/wander/docs/internals/scheduling/scheduling
...
[`restart` attempts]: https://openwander.org/wander/docs/job-specification/restart
[`max_client_disconnect`]: https://openwander.org/wander/docs/job-specification/group#max-client-disconnect
